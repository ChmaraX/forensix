# Authoritative licence sources for minishlab/M2V_base_output

## README.md
Source: https://huggingface.co/minishlab/M2V_base_output/raw/main/README.md
HTTP 200, 4899 chars (FULL, untruncated)
...
The results show that **M2V_base_output** reaches 87.40% of the performance of [all-MiniLM-L6-v2](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) with an average score of 48.77 while being orders of magnitude faster.
...
## LICENSE
Source: https://huggingface.co/minishlab/M2V_base_output/raw/main/LICENSE
HTTP 404 — NOT PRESENT

## LICENSE.txt
Source: https://huggingface.co/minishlab/M2V_base_output/raw/main/LICENSE.txt
HTTP 404 — NOT PRESENT

## LICENSE.md
Source: https://huggingface.co/minishlab/M2V_base_output/raw/main/LICENSE.md
HTTP 404 — NOT PRESENT

## NOTICE
Source: https://huggingface.co/minishlab/M2V_base_output/raw/main/NOTICE
HTTP 404 — NOT PRESENT
