# Authoritative licence sources for BAAI/bge-reranker-base


## README.md
Source: https://huggingface.co/BAAI/bge-reranker-base/raw/main/README.md
...
- 09/12/2023: New models: 
    ...
    - **update embedding model**: release `bge-*-v1.5` embedding model to alleviate th
```
